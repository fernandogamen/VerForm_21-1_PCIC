...
Proposition Dichotomy: forall n m, n <=1 m \/ m <=1 n.
Proof.
intro.
induction n.
- intros.
...
- intros.
  ...
  + inversion H.
    ...
    * right.
      ...
      eapply o1_trans.
      apply o1_nSn.
      apply (proj2 (o1_ss_equiv m m0)) in H0.
      apply (proj1 (o1_ss_equiv m (S m0))).
      eapply o1_trans.
      exact H0.
      apply o1_nSn.
Admitted.
