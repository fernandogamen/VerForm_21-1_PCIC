...
\title{Una definición no determinista de permutaciones}
\author{Favio E. Miranda Perea}
\date{\today} %\\ Fecha de entrega: mi 6 de marzo a las 2359hrs}


\begin{document}
\maketitle
% La entrega será en un archivo de script con el nombre {\tt ej02vf192\_apellido\_nombre.v}

La siguiente es una definición relacional para permutaciones de una lista, basada en un predicado de inserción no determinista.
...
La idea del proyecto es  implementar esta definición mediante predicados inductivos y
demostrar diversas propiedades de interés, en particular su equivalencia con la definición de la biblioteca de {\tt Coq} disponible en:
\begin{center}
\url{https://coq.inria.fr/library/Coq.Sorting.Permutation.html}
\end{center}
